...
****
You need an Apple Developer account and a provisioning certificate. Have a look at link:apple-setup.html[APNs Setup] for further instructions.
****
...
****
A Google account and access to the Firebase console. See link:google-setup.html[Firebase Setup] to get started.
****
...
****
You need a mobile provisioning certificate. Have a look at link:apple-setup.html[APNs Setup] for instructions on how to obtain one. Make sure that you have selected `iOS` in the `Mobile Client Type` dropdown.
