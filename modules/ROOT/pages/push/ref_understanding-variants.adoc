...
:context: ref_understanding-variants

[id='{context}_ref_understanding-variants']

= Understanding Variants

{unifiedpush-service} collects metadata and payload, and this is accessed using {unifiedpush-service} Variants screen.
