...
Administrative User Interface:: (AUI) The {unifiedpush-service} Web UI that allows you manage Push Applications and Variants, view statistics and send Push Notifications to devices.
