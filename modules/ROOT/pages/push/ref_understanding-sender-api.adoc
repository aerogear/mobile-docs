...
[id='{context}_ref_understanding-sender-api']

= Understanding Sender API

{unifiedpush-service} collects metadata and payload, and this is accessed using {unifiedpush-service} Sender API screen.
