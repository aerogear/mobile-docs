...
The {push-ui} allows you to send {push-notifications} to devices.
...
TIP: You can give a higher priority to a push message by setting its priority to 'high' instead of 'normal'.
