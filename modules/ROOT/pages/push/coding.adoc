...
. Download `google-services.json` an copy it to your app folder. For more details see link:google-setup.html[Google setup].
...
Finally you need to install the Unified Push Server package needed for device registration:
