...
= Using dashboards to display {metrics-service} service data

== Prerequisites

[x] A provisioned {metrics-service} service as described in xref:metrics/provisioning.adoc[Provisioning {metrics-service} Service]
