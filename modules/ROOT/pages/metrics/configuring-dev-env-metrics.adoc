...
* [x] You have associated the service with a {mobile-client} as described in xref:metrics/binding.adoc[Binding a {mobile-client} with the {service-name} Service] if you want to monitor usage by version of mobile app, platform and SDK.
