...
* [x] You have configured the app as described in xref:metrics/configuring-dev-env-metrics.adoc[Configuring your Development Environment]
...
For example, there might be an Admin Portal App and a Field Worker App both using the same backend services and same {metrics-service} Service.
