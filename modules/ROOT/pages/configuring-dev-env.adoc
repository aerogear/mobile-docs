...
dependencies {
    ...
    implementation 'org.aerogear:android-push:{installer-release-number} '
    implementation 'org.aerogear:android-auth:{installer-release-number} '
    implementation 'org.aerogear:android-security:{installer-release-number} '
}
----
...
----
dotnet add package AeroGear.Mobile.Core --version {installer-release-number} 
----
...
[source,bash,subs="attributes"]
----
dotnet add package AeroGear.Mobile.Core.Platform.Android --version {installer-release-number} 
----
...
[source,bash,subs="attributes"]
----
dotnet add package AeroGear.Mobile.Core.Platform.iOS --version {installer-release-number} 
----
