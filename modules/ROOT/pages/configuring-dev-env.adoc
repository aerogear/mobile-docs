...
Before installing the SDK you will need on your system, at least:
...
NOTE: when using link:https://ionicframework.com[Ionic] you don't need to install Cordova as it comes already included. Our own link:https://github.com/aerogear/cordova-showcase-template[Showcase template] is based on Ionic.

*Add AeroGear SDK*

1. Get a copy of `mobile-services.json` from the `Config Info` tab in your Openshift project. This JSON file contains custom configuration data for your project and shouldn't be changed manually. Every time a new service is provisioned the file has to be replaced with a new one.
