...
== Create an Android {mobile-client-openshift}

This guide demonstrates how to create an Android
link:./mobile-clients-in-openshift.adoc[{mobile-client-openshift}].
...
Android Application with your own back-end service in OpenShift]
