...
[[binding]]
// start keycloak/binding-an-app-to-a-service.adoc[leveloffset=1]
include::_partials/keycloak/binding-an-app-to-a-service.adoc[leveloffset=1]
// end keycloak/binding-an-app-to-a-service.adoc[leveloffset=1]

[[localdev]]
// start keycloak/configuring-the-service.adoc[leveloffset=2]
include::_partials/keycloak/configuring-the-service.adoc[leveloffset=2]
// end keycloak/configuring-the-service.adoc[leveloffset=2]
