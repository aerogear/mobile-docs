...
For more information about the {keycloak-service} provisioning wizard fields, see xref:{keycloak-service}-onfiguration-additional-resources[{keycloak-service} Configuration].

[id='{keycloak-service}-onfiguration-additional-resources']
[discrete]
