...
It is very easy to provide a custom conflict resolution strategy. It takes two parameters, `strategies` and `default`.

* strategies - a dictionary object defining the custom behaviour for any mutation you which to specify
