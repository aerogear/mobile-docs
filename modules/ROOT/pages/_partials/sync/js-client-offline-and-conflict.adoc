...
You can check error object to isolate errors relating to offline state.
`watchOfflineChange` method on error object will allow to watch when a change will be synced back to server,
