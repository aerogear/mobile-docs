...
In order to get notification about offline related events, the `offlineQueueListener` in the config object should be used. The following events are emitted:
