[id="server-deploying-your-app-built-using-the-data-sync-framework-to-production-{context}"]
= Deploying your app built using the data sync framework to Production
...
+
. Once the _application_ is created, click *Close*.
