...
- DataSync API Gateway

Provides a way for developers to deploy Node.JS API Gateway application directly from source code. Server can connect with other services running on OpenShift or connect to external data sources like database running on the separate server.
