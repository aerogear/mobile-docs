...
NOTE: This subscription server does not implement authentication or authorization. For information about implementing authenication and authorization, see xref:ds-auth.adoc[Supporting authentication and authorization in your mobile app].
