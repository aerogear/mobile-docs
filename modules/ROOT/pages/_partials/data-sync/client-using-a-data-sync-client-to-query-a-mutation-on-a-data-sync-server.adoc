[id="client-using-a-data-sync-client-to-query-a-mutation-on-a-data-sync-server-{context}"]
= Using a Data Sync Client to query a mutation on a Data Sync Server
