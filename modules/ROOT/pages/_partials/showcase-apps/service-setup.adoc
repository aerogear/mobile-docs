...
// tag::excludeDownstream[]
. To demonstrate {metrics-service}, xref:mobile-metrics.adoc#provisioning-metrics-service[Provision the {metrics-service} service]. For more information about features, see link:{metrics-guide-link}/[{metrics-service} Service].
// end::excludeDownstream[]
