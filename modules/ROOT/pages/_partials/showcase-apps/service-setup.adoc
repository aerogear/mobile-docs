...
// tag::excludeDownstream[]
. To demonstrate {metrics-service}, link:{metrics-guide-link}/[Provision the {metrics-service} service]. For more information about features, see link:{metrics-guide-link}/[{metrics-service} Service].
// end::excludeDownstream[]
