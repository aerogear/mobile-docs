...
For more information about these values, see the _DockerHub, Cluster IP and Wildcard DNS Host values_ section in Additional Resources.
+
...
For more information, see the _DockerHub, Cluster IP and Wildcard DNS Host values_ section in Additional resources.
+
