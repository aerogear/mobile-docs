...
* A link:https://hub.docker.com/[Docker Hub, window="_blank"] account
...
----
+
The following installation can take a while the first time it runs, as it pulls a number of Docker images.
Once output similar to the following is displayed it indicates that it has completed successfully and you can proceed.
+
----
