...
. Click *Bind to App* for {mobile-security-service}.

. Fill out the binding parameters required by the {mobile-security-service} Service.


The {mobile-security-service} service will now be expandable, details about the service can be viewed.
