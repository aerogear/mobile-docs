...
. Code the device registration
+
To use the {unifiedpush-service} service, devices must be registered. 
This registration is performed by calling an endpoint of the server.
+
[tabs]
====
// tag::excludeDownstream[]
