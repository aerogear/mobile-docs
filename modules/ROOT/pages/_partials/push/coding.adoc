...
+
--
A link:https://firebase.google.com/[Firebase account, window="_blank"].
--
iOS::
+
--
An link:https://developer.apple.com/library/archive/documentation/NetworkingInternet/Conceptual/RemoteNotificationsPG/APNSOverview.html#//apple_ref/doc/uid/TP40008194-CH8-SW1[APNs service, window="_blank"].
--
