...
For more details about how to provision the {mobile-ci-cd-service} service, {mobile-ci-cd-service} service guide.
...
For more information about how to configure the build config, please see the build config section of {mobile-ci-cd-service}.
