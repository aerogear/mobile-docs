...
you should be able to see the "{idm-name} Metrics" in the list of available dashboards (navigate to Grafana's exposed URL -> Log in -> Home -> Select *{idm-name} Metrics*).
