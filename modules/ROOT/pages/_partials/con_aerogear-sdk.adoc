...
include::{remote-loc}./conf-dev-env-android.adoc[]
...
include::{remote-loc}./conf-dev-env-ios.adoc[]
...
include::{remote-loc}./conf-dev-env-cordova.adoc[]
...
include::{remote-loc}./conf-dev-env-xamarin.adoc[]
