...
AeroGear SDK is hosted on link:https://www.npmjs.com/[npm] for Cordova, link:https://www.nuget.org/[NuGet] for Xamarin, link:https://bintray.com/bintray/jcenter[jCenter] for Android and on link:https://cocoapods.org/[CocoaPods] for iOS.
