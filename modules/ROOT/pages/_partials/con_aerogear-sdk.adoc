...
After you have registered a {mobile-client}, bound the {mobile-client} to a mobile service, and downloaded the mobile services configuration file, you can start developing your mobile app using mobile services.
...
* Steps for {keycloak-service}
* Steps for {unifiedpush-service}
* Steps for {device-security-service}
