...
* xref:android[Android]
* xref:ios[iOS]
* xref:cordova[Cordova]
* xref:xamarin[Xamarin]

[[android]]
== Implementing AeroGear SDK into Android apps
...
[[ios]]
== Implementing AeroGear SDK into iOS apps
...
[[cordova]]
== Implementing AeroGear SDK into Cordova apps
...
[[xamarin]]
== Implementing AeroGear SDK into Xamarin apps
