...
include::{partialsdir}/metrics-index.inc-rantora.adoc[tags=about-metrics]
...
include::{partialsdir}/push-index.inc-rantora.adoc[tags=about-push]
...
include::{partialsdir}/auth-index.inc-rantora.adoc[tags=about-auth]
...
include::{partialsdir}/custom-index.inc-rantora.adoc[tags=about-custom]
...
include::{partialsdir}/build-index.inc-rantora.adoc[tags=about-build]
