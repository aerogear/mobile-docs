...
include::_partials/metrics/3_downloading-configuration-file.adoc[leveloffset=+1]
include::_partials/metrics/4_setting-up-sdk.adoc[leveloffset=+1,tags=!excludeUpstream]
include::_partials/metrics/5_analysing-app-usage.adoc[leveloffset=+1]

[[monitoring]]
// start metrics/monitoring-keycloak.adoc[leveloffset=1]
include::_partials/metrics/6_monitoring-keycloak.adoc[leveloffset=1]
include::_partials/metrics/7_monitoring-sync.adoc[leveloffset=1]
include::_partials/metrics/8_monitoring-keycloak.adoc[leveloffset=1]
