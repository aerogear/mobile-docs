...
include::{remote-loc}_partials/security/ref_terminology.adoc[leveloffset=+2]

[[setting-up-the-device-security-service]]
== Configuring your Development Environment for the {device-security-service} Service
include::{remote-loc}_partials/security/downloading-configuration-file.adoc[leveloffset=+1]
include::{remote-loc}_partials/security/setting-up-the-security-sdk.adoc[leveloffset=+2]
include::{remote-loc}_partials/security/performing-device-checks.adoc[leveloffset=+1]
include::{remote-loc}_partials/security/pinning-certificates.adoc[leveloffset=+1]
