...
[#registering]
include::mc-registering-a-mobile-client.adoc[leveloffset=1]
[#services]
include::mc-viewing-available-services.adoc[leveloffset=1]
[#binding]
include::mc-binding-mobile-services.adoc[leveloffset=1]
[#configuring]
include::mc-configuring-and-running-builds.adoc[leveloffset=1]
[#running]
include::mc-downloading-and-installing-apps.adoc[leveloffset=1]
