...
[#server-deploying-your-app-built-using-the-data-sync-framework-to-an-environment]
include::_partials/sync/server-deploying-your-app-built-using-the-data-sync-framework-to-an-environment.adoc[leveloffset=2]
