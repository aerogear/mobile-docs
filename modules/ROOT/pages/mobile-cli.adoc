...
The Mobile CLI allows developers to work with {product-name} from the command line, for example using the following commands:
...
all of the available service configs. This resource is the
configuration required to consume the mobile aware services
