...
. Create the authService field and retrieve the auth service:
+
[source,java]
----
AuthService authService; // field declaration
authService = MobileCore.getInstance().getService(AuthService.class); // initialize the authService
----
