...
NOTE: You must create a new user account before you can log into the Showcase App. To create a new user, follow the steps link:https://www.keycloak.org/docs/3.3/server_admin/topics/users/create-user.html[here, window="_blank"] and to setup a new users credentials, follow the steps link:https://www.keycloak.org/docs/3.3/server_admin/topics/users/credentials.html[here, window="_blank"].
