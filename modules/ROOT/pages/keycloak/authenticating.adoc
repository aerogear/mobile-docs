...
As noted in xref:keycloak/coding.adoc#initializing-the-sdk[initializing the SDK] Auth service initialization also
performs the authentication action.

However, for perfoming that manually, invoke the login function:
