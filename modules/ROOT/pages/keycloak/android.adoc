...
* xref:keycloak/provisioning.adoc[Provisioned Keycloak service].
* xref:keycloak/binding.adoc[Binding] created.
* A configuration file added to the apps assets directory.
* Core module imported.

include::./proc_android-setup-keycloak.adoc[leveloffset=+1]
