...
// start {partialsdir}/identity-management.adoc[leveloffset=2]
include::{partialsdir}/identity-management.adoc[leveloffset=2]
// end {partialsdir}/identity-management.adoc[leveloffset=2]
