...
To detect whether a devices filesystem is encrypted the `SecurityCheckType#HAS_ENCRYPTION_ENABLED` function is used. This function uses Android's link:https://developer.android.com/reference/android/app/admin/DevicePolicyManager.html[DevicePolicyManager] class.
