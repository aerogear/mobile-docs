...
include::{remote-loc}_partials/generic-provisioning.adoc[]
...
include::{remote-loc}_partials/generic-provisioning-end.adoc[]
...
include::{remote-loc}_partials/generic-binding.adoc[]
+
