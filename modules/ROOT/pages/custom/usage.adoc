...
[source,java]
----
String property = config.getProperty("[PROPERTY NAME]");
----
...
[source,swift]
----
let config = AgsCore.instance.getConfigurationById("[SERVICE NAME]")
----
...
[source,swift]
----
let property: JSONValue = config.config["[PROPERTY NAME]"]
----
