...
include::{remote-loc}_partials/push/obtaining_firebase_cloud_messaging_credentials.adoc[leveloffset=+2]
include::{remote-loc}_partials/push/enable_push_notifications_for_ios_app.adoc[leveloffset=+2]
include::{remote-loc}_partials/push/provisioning-the-push.adoc[leveloffset=+2]
include::{remote-loc}_partials/push/binding-an-app-to-a-service.adoc[leveloffset=+2]
[[setting-up-the-push-client-app]]
== Configuring your client app
include::{remote-loc}_partials/push/downloading-configuration-file.adoc[leveloffset=+2]
include::{remote-loc}_partials/push/setting-up-the-push-sdk.adoc[leveloffset=+2]
include::{remote-loc}_partials/push/registering_device.adoc[leveloffset=+1]
include::{remote-loc}_partials/push/sending-a-push-notification.adoc[leveloffset=+1]
include::{remote-loc}_partials/push/handling-push-notifications.adoc[leveloffset=+1]
