...
== Shutting down and restoring your cluster

To shut down the local cluster run
...
To bring the cluster back with the state in tact run the following commands replacing `<IP_ADDRESS>` with your clusters IP
