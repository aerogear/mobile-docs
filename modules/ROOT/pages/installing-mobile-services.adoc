...
* Docker is a requirement, and must be version 17.09.1 in order to be compatible with the latest release of OpenShift, depending on your OS this is downloaded from different places:

[role="primary"]
.MacOS

****
On Darwin / MacOSX operating systems, you must install version link:https://download.docker.com/mac/stable/19543/Docker.dmg[17.09.1] of Docker.
****
...
****
On Linux you must install version 17.09.1 of Docker which is available link:https://download.docker.com/linux/centos/7/x86_64/stable/Packages/docker-ce-17.09.1.ce-1.el7.centos.x86_64.rpm[here].
****
