...
include::{remote-loc}_partials/metrics/provisioning-the-metrics.adoc[leveloffset=+2]
include::{remote-loc}_partials/metrics/binding-an-app-to-a-service.adoc[leveloffset=+2]
== Configuring your development environment for the {metrics-service} Service
include::{remote-loc}_partials/metrics/downloading-configuration-file.adoc[leveloffset=+1]
include::{remote-loc}_partials/metrics/setting-up-sdk.adoc[leveloffset=+1,tags=!excludeUpstream]
include::{remote-loc}_partials/metrics/analysing-app-usage.adoc[leveloffset=+1]

[[monitoring]]
// start metrics/monitoring-keycloak.adoc[leveloffset=1]
include::{remote-loc}_partials/metrics/monitoring-keycloak.adoc[leveloffset=1]
include::{remote-loc}_partials/metrics/monitoring-sync.adoc[leveloffset=1]
include::{remote-loc}_partials/metrics/viewing-keycloak-dashboards.adoc[leveloffset=1]
