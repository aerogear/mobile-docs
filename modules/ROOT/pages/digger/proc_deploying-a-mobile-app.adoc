...
This binary can be downloaded for any succesfult build in the build history.
...
. Expand the pipeline which you want to deploy.

. Click *Download* on the build you want to deploy.

. Download the binary, either by scanning the QR code using your mobile device or using the URL.
