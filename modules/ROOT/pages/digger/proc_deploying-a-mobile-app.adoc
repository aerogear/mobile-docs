...
You can use the OpenShift UI to deploy a mobile app by downloading the binary directly to the mobile device, this binary can be downloaded for any succesful build in 
the build history.
...
. In the mobile overview for the mobile client open the "Build tab".

. Expand the pipeline which you wish to deploy.

. Click 'Download' on the build you wish to deploy.

. Download the binary, either by the URL or scan the QR code from your mobile device.
