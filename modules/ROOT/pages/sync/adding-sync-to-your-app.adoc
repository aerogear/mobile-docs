...
Client SDK provides a simple way to get the Apollo client configured to use.
...
Note: Check the link:https://github.com/apollographql/apollo-android/[Apollo GraphQL Client for Android] for a complete list of options.
****
