...
You can use a async method `query` from SyncClient
...
SyncClient
    ...
    .respondWith(new Responder<Response<MyNotesQuery.Data>>() {
        @Override
        public void onResult(Response<MyNotesQuery.Data> response) {
...
Or use the `Query` method from Apollo client to fire a query:
...
You can use a async method `mutate` from SyncClient
...
SyncClient
    ...
    .respondWith(new Responder<Response<CreateNoteMutation.Data>>() {
        @Override
        public void onResult(Response<CreateNoteMutation.Data> response) {
            // Do some magic with the response
        }
...
Or use the `Mutate` method from Apollo client to fire a mutation:
...
You can use a utilite method `subscribe` from SyncClient
...
or the `subscribe` method from Apollo client to fire a subscription
