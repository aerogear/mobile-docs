...
----
+
NOTE: If you use a Docker Hub organization, set a variable for it using `export DOCKERHUB_ORG=<your docker hub org>`, otherwise the addon will default the value to `aerogearcatalog`.
