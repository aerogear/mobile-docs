...
* You have set up xref:getting-started.adoc#setting-up-aerogear-mobile-services-on-openshift[AeroGear Mobile Services] on OpenShift.

* You have xref:getting-started.adoc#registering[registered a mobile app] to create a {mobile-client}.
