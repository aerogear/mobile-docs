...
* You have provisioned one of the {product-name}.
* You have associated the service with a {mobile-client} as described in xref:binding-mobile-app-record-to-mobile-services.adoc[Binding a {mobile-client} with Mobile Services].
